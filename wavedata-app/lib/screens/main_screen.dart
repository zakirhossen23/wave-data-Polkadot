...
class _MainScreenState extends ConsumerState<MainScreen> {
  ...
  Future<void> GetAvialbleData() async {
    avilableTrials = [];
    var url = Uri.parse(
        'https://wave-data-celo-api.onrender.com/api/GET/Trial/GetAvailableTrial?userid=${userid}');
  ...
  Future<void> GetOngoingData() async {
    ...
    dummyActions = [];
    var url = Uri.parse(
        'https://wave-data-celo-api.onrender.com/api/GET/Trial/GetOngoingTrial?userid=${userid}');
    final response = await http.get(url);
    var responseData = json.decode(response.body);
  ...
  Future<void> GetFHIRData(int userid) async {
    ...
    var urlFH = Uri.parse(
        'https://wave-data-celo-api.onrender.com/api/GET/getFhir?userid=${int.parse(userid.toString())}');
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> StartTrial(int trialid) async {
      ...
      var url = Uri.parse(
          'https://wave-data-celo-api.onrender.com/api/POST/Trial/CreateOngoingTrail');
    ...
    void UpdateImage() async {
      ...
      int userid = int.parse(prefs.getString("userid").toString());
      var url = Uri.parse(
          'https://wave-data-celo-api.onrender.com/api/POST/UpadateImage');
      await http.post(url, headers: POSTheader, body: {
        'userid': userid.toString(),
