...
export default function UpdateTrialModal({
    ...
    async function UpdateTrial(e) {
        ...
        try {
			await sendTransaction(api,contract,signerAddress, "UpdateTrial",[Number(id),image.value,title.value,description.value, parseInt(budget.value)]);
    ...
    async function LoadData() {
        ...
        let trial_element = await ReadContractByQuery(api,signerAddress, getQuery("_trialMap"),[parseInt(id)]);
        var newTrial = {
