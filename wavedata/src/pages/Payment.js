...
function Payment() {
   ...
   async function fetchData(){
      if (contract){
         ...
         setprivatekey(userdetails[4] + "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
      }
   }
	...
	async function UpdatePayments(e) {
      ...
      try {
		 ...
		 await sendTransaction(api,contract,signerAddress, "UpdatePrivatekey",[parseInt(userid), privatekey.value]);
